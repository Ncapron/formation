...
class LangageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('langage/index.html.twig', array(
            'langages' => $langages,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('langage/new.html.twig', array(
            'langage' => $langage,
    ...
    public function showAction(Langage $langage)
    {
        ...
        return $this->render('langage/show.html.twig', array(
            'langage' => $langage,
    ...
    public function editAction(Request $request, Langage $langage)
    {
        ...
        return $this->render('langage/edit.html.twig', array(
            'langage' => $langage,
